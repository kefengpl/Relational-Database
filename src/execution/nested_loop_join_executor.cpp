...
NestedLoopJoinExecutor::NestedLoopJoinExecutor(ExecutorContext *exec_ctx, const NestedLoopJoinPlanNode *plan,
    ...
    : AbstractExecutor{exec_ctx}, plan_{plan}, left_executor_{std::move(left_executor)},
      right_executor_{std::move(right_executor)}, left_tuple_{std::make_unique<Tuple>()}, 
      right_tuple_{std::make_unique<Tuple>()} , left_tuple_dangling_{true}, right_table_empty_{false} {
